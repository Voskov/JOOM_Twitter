...
from app.services.feed_service import get_follow_feed, get_global_feed, get_user_feed
...
async def following_feed(
    ...
    return await get_follow_feed(
        current_user=current_user, db=db, redis=redis, limit=limit, offset=offset
    )
